    ...
    return (
        <div className="tdtu-page-wrapper">
            ...
            <div className="tdtu-contact-connect">
                <h2 className="connect-title">Kết nối ngay với bộ phận tư vấn tuyển sinh TDTU</h2>
                <div className="connect-buttons">
                    <a href="tel:19002024" className="connect-button">
                        📞 Tư vấn trực tiếp Đại học
                    </a>
                    <a href="https://example.com/tu-van-online" className="connect-button">
            ...
            <footer className="tdtu-footer">
                <div className="tdtu-footer-columns">
                    <div className="footer-col">
                        ...
                        <p>Số 19 Nguyễn Hữu Thọ, Phường Tân Phong,<br />Quận 7, TP. Hồ Chí Minh, Việt Nam</p>
                        <p><strong>Tư vấn tuyển sinh đại học:</strong></p>
                        <p>Hotline: 19002024<br />Email: tuvantuyensinh@tdtu.edu.vn</p>
                        <p><strong>Tư vấn tuyển sinh sau đại học:</strong></p>
                        <p>Hotline: 0944 314 466<br />Email: saudaihoc@tdtu.edu.vn</p>
                        <p><strong>Hotline:</strong> 0935 035 270<br />Email: tuvantuyensinhkqt@tdtu.edu.vn</p>
                    </div>
